...
def summarize_daily_briefing(news_list):
    ...
    가독성이 매우 중요하므로 이모지를 적절히 사용하고, 아래의 5가지 핵심 섹션으로 나누어 서울과 지방을 분리해서 요약해 주세요.

    1. 📰 **오늘의 부동산 핵심 이슈 (세금/정책/법령/전국 동향)**
    2. 💰 **오늘의 대출 규제 및 금리 동향 (가장 중요)**
    3. 🏙️ **[서울/수도권] 동향 및 핫플레이스 요약**
    4. 🏞️ **[지방/기타지역] 동향 및 핫플레이스 요약**
    5. 💡 **오늘의 투자 인사이트 (애널리스트 한 줄 평)**
